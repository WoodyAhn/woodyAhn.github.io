...
$$ \\begin{align\*} SCR = {(C\_{1}, S\_{1}),\\cdots, (C\_{k}, S\_{K})} \\end{align\*} $$
...
$$score(o) = \\sum\_{\\{(C,S)\\in SCR | o\\in C\\}} evidence(o, (C, S), SCR)$$
...
$$avgCC(SCR) = \\sum\_{o\\in DB}ClusterCount(o, SCR) / |DB|$$
