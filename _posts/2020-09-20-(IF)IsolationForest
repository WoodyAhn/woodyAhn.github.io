...
{% include figure image_path="/assets/images/OutlierDetection/IsolatoinForest/fig2.png" alt="this is a placeholder image" caption=" " %}
...
{% include figure image_path="/assets/images/OutlierDetection/IsolatoinForest/fig3.png" alt="this is a placeholder image" caption=" " %}
...
{% include figure image_path="/assets/images/OutlierDetection/IsolatoinForest/fig4.png" alt="this is a placeholder image" caption=" " %}
...
{% include figure image_path="/assets/images/OutlierDetection/IsolatoinForest/fig5.png" alt="this is a placeholder image" caption=" " %}
